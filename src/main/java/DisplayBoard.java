public class DisplayBoard {
    ...
    private final String WHITE_PIECE = BLACK_BACKGROUND + "\033[38;5;255m" + "(O)" + WHITE_FOREGROUND + "\033[0m";
    private final  String BLACK_PIECE = BLACK_BACKGROUND + "\033[38;5;232m" + "(O)" + BLACK_FOREGROUND+ "\033[0m";
    private final  String WHITE_QUEEN = BLACK_BACKGROUND + "\033[38;5;255m" + "[+]" + WHITE_FOREGROUND + "\033[0m";
    private final String BLACK_QUEEN = BLACK_BACKGROUND + "\033[38;5;232m" + "[+]" + BLACK_FOREGROUND + "\033[0m";//"[♚]"
